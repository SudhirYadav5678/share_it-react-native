...
const QRScannerMdal: FC<ModalProps> = ({ visible, onClose }) => {
        ...
        >
            <View style={modalStyles.modalContainer}>
                <View style={modalStyles.qrContainer}>
                    {
                        loading ? (<View style={modalStyles.skeleton}>
                            ...
                            </View>) : (<View style={modalStyles.skeleton}>
                ...
                <View style={modalStyles.info}>
                    ...
                    <CustomText style={modalStyles.infoText2}>
                        Ask the receiver to show QR Code to connet and transfer files.
                    </CustomText>
                </View>
